...
public class Mini {
	...
	private MiniFare fare_breakup;
	public Mini(String id, String display_name, String currency, String distance_unit, String time_unit, String eta, String distance, MiniFare fare) {
		this.id = id;
	...
	public MiniFare getFare() {
		return fare_breakup;
	}

	public void setFare(MiniFare fare) {
		this.fare_breakup = fare;
	}
